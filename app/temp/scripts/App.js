...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.menuBtn = (0, _jquery2.default)(".site-header__btn-container");
		this.events();
	}
	...
	_createClass(MobileMenu, [{
		...
		value: function toggleTheMenu() {
			...
			this.menuBtn.toggleClass("site-header__btn-container--is-visible");
		}
	}]);
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.scrollLink = (0, _jquery2.default)(".scroll-link");
		...
		value: function createPageSectionWaypoints() {
			...
			this.scrollLink.each(function () {
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							var matchingHeaderLink = currentPageSection.getAttribute("data-match");
...
var Modal = function () {
	function Modal() {
		...
		this.closeModalButton2 = (0, _jquery2.default)(".modal-2__close");
		this.events();
	}
